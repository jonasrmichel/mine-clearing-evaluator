...
public class Script extends FileModel {
	...
	public void processLine(String line) {
		Logger.printDebug(Script.class, "processing " + line);

		// tokenize and parse the line
		String[] lineTokens = line.trim().replaceAll("\\s+", " ").split(" ");
	...
	public void validate() {
		...
		if (instructions.isEmpty())
			Logger.printErrorAndExit(Script.class, "Please provide a non-empty script file");
	}
